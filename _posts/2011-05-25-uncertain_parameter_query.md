...
tags:
  ...
  - '%e6%9e%84%e9%80%a0sql%e6%9f%a5%e8%af%a2'
...
<coolcode lang="sql" linenum="off">queryf("select * from glove_user where name = '%s' and site = '%s'", 'glove', 'glovely.info');</coolcode>
...
实例1:
<coolcode lang="php" linenum="off">function queryf(){
