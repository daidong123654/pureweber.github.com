...
提交邮箱后请查看你的电子邮件，会有我们发给你的一封认证邮件。点击里面的链接进行下一步。

###输入用户名和密码

用户名和密码是用来登录的凭证，请一定不要忘记，不然会很麻烦的。

<a target="_blank" href="http://min.us/mvnEnfW#3"><img src="http://i.min.us/jlwk1q.png" width="300" border="0" /></a>

###完成注册
下面给自己取一个好听的昵称吧！

<a target="_blank" href="http://min.us/mvnEnfW#4"><img src="http://i.min.us/jl00Hq.png" width="300" border="0" /></a>
